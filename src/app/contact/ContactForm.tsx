...
export default function ContactForm() {
  ...
  const infoItems = [
    { icon: MapPin, title: "Address", text: "Gauradaha, Jhapa, Nepal" },
    { icon: Phone, title: "Phone", text: "+977-9840036888" },
    { icon: Mail, title: "Email", text: "gmsflowerstore@gmail.com" },
    { icon: Clock, title: "Hours", text: "Sun-Fri: 7:00 AM - 6:00 PM" },
  ];
