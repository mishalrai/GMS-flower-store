    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm">
        ...
        <p className="text-center text-xs text-gray-500 mt-3">
          ...
          <Link href="/register" className="text-[#6FB644] font-medium hover:underline">
            Sign up
          </Link>
        </p>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={loadingProvider !== null}
            className="w-full flex items-center justify-center gap-3 bg-[#1877F2] rounded-lg py-2.5 px-4 text-sm font-medium text-white hover:bg-[#166fe5] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
